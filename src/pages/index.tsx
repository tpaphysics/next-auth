    ...
    <>
      <main>
        <section className="absolute w-full h-full">
          <div className="absolute top-0 w-full h-full bg-gray-900 bg-[url('/img/register_bg_2.png')] bg-no-repeat"></div>
                  ...
                  <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    ...
                    <form>
                      ...
                      <div className="text-center mt-6">
                        <button
                          className="bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full hover:bg-gray-800 cursor-not-allowed"
                          type="button"
                          style={{ transition: "all .15s ease" }}
                        >
                          Sign In
